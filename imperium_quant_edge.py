...
st.markdown("**Smart Adaptive AI with Live Balance**")
...
if auto_trading and st.session_state.get('connected') and (continuous or burst):
    st.success("🧠 Smart Adaptive AI Running - Live Balance")
...
with st.container():
    ...
    st.info("Balance updates live with each trade")
