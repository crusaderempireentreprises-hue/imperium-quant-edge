# ============================================================
#  IMPERIUM QUANT EDGE v7.1 — Adaptive Reinforcement Learning Engine
...
class EngineConfig:
    ...
    # Meta-policy mode (auto-switching)
    meta_mode: str = "ADAPTIVE"       # always adaptive in v6+
...
def build_contract(symbol: str) -> Contract:
    """
    Returns the correct IBKR contract type depending on the symbol.
    FX → Forex()
    Gold → Commodity()
    Bitcoin → Crypto()
    """
...
# ============================================================
#  SECTION 2 — STATE ENGINE + FEATURE EXTRACTION
# ============================================================
...
# ============================================================
#  SECTION 3 — RL CORE (Reward, Policy Update, TD Learning)
# ============================================================
...
def score_to_action(score: float, threshold: float = 0.2) -> Optional[str]:
    if score > threshold:
        return "BUY"
...
# ============================================================
#  SECTION 4 — META-POLICY SWITCHING
# ============================================================
...
# ============================================================
#  SECTION 5 — EXECUTION ENGINE + IBKR INTEGRATION
# ============================================================
...
# ============================================================
#  v7 — MARGIN + PORTFOLIO RL + NETTING
# ============================================================
...
def update_margin(acct: AccountState, mkts: dict):
    ...
    equity = acct.balance + acct.total_realized_pnl + acct.total_unrealized_pnl
    acct.free_margin = equity - acct.margin_used
    acct.withdrawable_balance = max(0.0, acct.free_margin)
...
def render_ui():
    st.title("⚔️ Imperium Quant Edge v7.1 — Adaptive RL Trading Engine")
    ...
    st.metric("Margin Used", f"${acct.margin_used:,.2f}")
    st.metric("Free Margin", f"${acct.free_margin:,.2f}")
...
# ============================================================
#  SECTION 8 — FINAL ASSEMBLY (MAIN APP)
# ============================================================
