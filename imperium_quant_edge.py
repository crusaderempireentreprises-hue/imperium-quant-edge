...
if auto_trading and "Live" in mode:
    st.sidebar.error("⚠️ Auto trading disabled in Live mode for safety. Test in Paper first.")
...
with tab4:
    ...
    - Test for several weeks before switching to Live mode.
    - Keep IB Gateway running on your computer.

    **TD Canada Trust withdrawals**: Manual via IBKR Client Portal (CAD EFT, no hard minimum).
    """)
