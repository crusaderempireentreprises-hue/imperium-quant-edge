...
st.markdown("**Real IBKR Trading - More Currencies**")
...
markets = st.sidebar.multiselect("Select Currencies & Markets", 
    [
        "XAUUSD", "EUR.USD", "USD.CAD", "GBP.USD", "USD.JPY", "AUD.USD", 
        "USD.CHF", "EUR.GBP", "EUR.JPY", "GBP.JPY", "AUD.JPY", "NZD.USD",
        "USD.MXN", "EUR.CHF", "GBP.CHF", "AAPL", "TSLA"
    ],
    default=["XAUUSD", "EUR.USD", "USD.CAD", "GBP.USD", "USD.JPY"])
...
if auto_trading and st.session_state.get('connected') and (continuous or burst):
    ...
    # (Trading code can be added here later)

st.subheader("📜 Status")
with st.container():
    st.markdown('<div class="box">', unsafe_allow_html=True)
    st.info("Click Refresh Balance after connecting. Check TWS for real activity.")
