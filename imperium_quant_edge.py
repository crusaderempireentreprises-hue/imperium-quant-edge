...
st.markdown("**Trading Restored - Stable Version**")
...
if auto_trading and st.session_state.get('connected') and (continuous or burst):
    ...
    st.success(f"🚀 {'Burst Mode ⚡' if burst else 'Continuous Trading'} RUNNING")
    ...
    while continuous or burst:
        ...
        with placeholder.container():
            ...
            st.metric("Orders This Cycle", executed)
        
        time.sleep(0.6 if burst else 1.5)

st.subheader("Status")
st.info("Turn on Auto Trading + Continuous or Burst to start trading")
