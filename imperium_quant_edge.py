...
st.markdown("**Real IBKR Trading Version - Fixed**")
            ...
            for sym in markets:
                if random.random() < 0.45:
                    ...
                    try:
                        ...
                        elif "." in sym and len(sym) == 7:   # Forex like EUR.USD
                            contract = Forex(sym)
                        ...
                        st.markdown(f"<h4 style='color:#00ff88;'>✅ REAL ORDER SENT: {signal} {size} {sym}</h4>", unsafe_allow_html=True)
                    except Exception as e:
...
with st.container():
    ...
    st.info("Check **TWS → Trades tab** and **Orders tab** for real activity")
